...
# Create a symlink from ~/canvas_account_admin_tools to /vagrant as a convenience for the developer
file {'/home/vagrant/canvas_account_admin_tools':
    ensure => link,
    target => '/vagrant',
}
...
exec {'create-virtualenv':
    ...
    user => 'vagrant',
    group => 'vagrant',
    require => [ Package['virtualenvwrapper'], File['/home/vagrant/canvas_account_admin_tools'], File['/etc/profile.d/oracle.sh'],
                 Exec['known_hosts'], ],
    ...
    creates => '/home/vagrant/.virtualenvs/canvas_account_admin_tools',
}

# set the DJANGO_SETTINGS_MODULE environment variable
file_line {'add DJANGO_SETTINGS_MODULE env to postactivate':
    ensure => present,
    line => 'export DJANGO_SETTINGS_MODULE=canvas_account_admin_tools.settings.local',
    path => '/home/vagrant/.virtualenvs/canvas_account_admin_tools/bin/postactivate',
...
file_line {'add DJANGO_SETTINGS_MODULE env to postdeactivate':
    ...
    path => '/home/vagrant/.virtualenvs/canvas_account_admin_tools/bin/postdeactivate',
    require => Exec['create-virtualenv'],
}
...
exec {'init-db-and-migrate':
    ...
    unless => 'psql -lqt | cut -d \| -f 1 | grep -wq canvas_account_admin_tools',
    logoutput => true,
}
...
echo "Activating python virtual environment \"canvas_account_admin_tools\""
