...
class CourseInfoAddTest(CourseInfoBaseTestCase):
    ...
    def test_add_person(self, test_case_id, test_user, canvas_role, role_id):
        ...
        # add user to role
        people_page.search_and_add_user(test_user, canvas_role)
        ...
        self.assertTrue(people_page.is_person_on_page(test_user))
    ...
    #     people_page.delete_user(test_user)
    #
    #
    #     self.assertTrue(people_page.delete_was_successful())
    #
    #     self.assertTrue(people_page.is_person_removed_from_list(test_user))
    #
