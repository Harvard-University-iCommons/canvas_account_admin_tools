...
class CourseSearchPageObject(CourseInfoBasePageObject):
    ...
    def select_school(self, school):
        ...
        # Select(self.find_element(*CourseSearchPageLocators.SELECT_SCHOOL_DROPDOWN)).select_by_value(school)
        self.focus_on_tool_frame()
    ...
    def select_year(self, year):
        """ select a school from the year dropdown """
        Select(self.find_element(*CourseSearchPageLocators.SELECT_YEAR_DROPDOWN)).select_by_value(year)

    def select_term(self, term):
        """ select a school from the term dropdown """
        Select(self.find_element(*CourseSearchPageLocators.SELECT_TERM_DROPDOWN)).select_by_value(term)

    def select_course_type(self, type):
        """ select a school from the course type dropdown """
        Select(self.find_element(*CourseSearchPageLocators.SELECT_COURSE_TYPE_DROPDOWN)).select_by_value(type)
