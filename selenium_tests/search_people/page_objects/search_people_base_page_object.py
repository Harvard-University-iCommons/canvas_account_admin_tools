...
class Locators(object):
    ...
    SEARCH_BY_BUTTON = (By.ID, "search-type-button")
...
class SearchPeoplePageObject(BasePageObject):
    page_loaded_locator = Locators.SEARCH_BY_BUTTON

    def __init__(self, driver):
        super(SearchPeoplePageObject, self).__init__(driver)
