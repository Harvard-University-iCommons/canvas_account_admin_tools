...
urlpatterns = [
    ...
    re_path(r'^api/schools/', api.schools, name='api_schools'),
    ...
    re_path(r'^audit/', views.audit, name='audit'),
    re_path(r'^bulk_job_detail/(?P<bulk_job_id>[\d]+)/', views.bulk_job_detail, name='bulk_job_detail'),
    re_path(r'^course_selection/', views.course_selection, name='course_selection'),
    re_path(r'^create_canvas_course', api.create_canvas_course_and_section, name='api_create_canvas_course'),
    re_path(r'^copy_canvas_template/', api.copy_from_canvas_template, name='api_copy_from_canvas_template'),
    re_path(r'^create_job/', views.create_job, name='create_job'),
