...
def check_user_id_integrity(login_id_required=True, missing_login_id_redirect_url=None):
    # TODO: info, debug, error logging
    # TODO: require GET param or make it work with POST as well
    # TODO: unit tests for missing and login required
    # TODO: documentation
    """
...
def course_selfreg(request, canvas_course_id):
    # Note: course_selfreg does not need a user ID integrity check as this endpoint will not be called from Canvas
